  ...
  <div class="relative mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8 lg:py-40">
    ...
    <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-12 xl:gap-x-16">
      <div class="lg:col-span-1">
        <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl"><?php echo get_field('homepage_offset_2x2_grid_heading', 'option'); ?></h2>
      </div>
      <dl class="mt-20 grid grid-cols-1 gap-16 sm:grid-cols-2 sm:gap-x-12 lg:col-span-2 lg:mt-0">
        <div>
          <dt>
            ...
            <p class="mt-6 text-lg font-semibold leading-8 text-gray-900">
							<?php echo get_field('homepage_offset_2x2_grid_section_1_heading', 'option'); ?>
						</p>
          </dt>
          <dd class="mt-2 text-base text-gray-600">
						<?php echo get_field('homepage_offset_2x2_grid_section_1_body', 'option'); ?>
					</dd>
        </div>
        ...
        <div>
          <dt>
            ...
            <p class="mt-6 text-lg font-semibold leading-8 text-gray-900">
							<?php echo get_field('homepage_offset_2x2_grid_section_2_heading', 'option'); ?>
						</p>
          </dt>
					<dd class="mt-2 text-base text-gray-600">
						<?php echo get_field('homepage_offset_2x2_grid_section_2_body', 'option'); ?>
					</dd>
        </div>
            ...
            <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-500 text-white">
              ...
              <svg class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
						...
						<p class="mt-6 text-lg font-semibold leading-8 text-gray-900">
							<?php echo get_field('homepage_offset_2x2_grid_section_3_heading', 'option'); ?>
						</p>
          </dt>
					<dd class="mt-2 text-base text-gray-600">
						<?php echo get_field('homepage_offset_2x2_grid_section_3_body', 'option'); ?>
					</dd>
        </div>
            ...
            <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-500 text-white">
              ...
              <svg class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
						...
						<p class="mt-6 text-lg font-semibold leading-8 text-gray-900">
							<?php echo get_field('homepage_offset_2x2_grid_section_4_heading', 'option'); ?>
						</p>
          </dt>
					<dd class="mt-2 text-base text-gray-600">
						<?php echo get_field('homepage_offset_2x2_grid_section_4_body', 'option'); ?>
					</dd>
        </div>
      </dl>
    </div>
