    ...
    <div class="mx-auto flex max-w-7xl items-center justify-between py-5 px-6 sm:py-4 md:justify-start md:space-x-10 lg:px-8">
      ...
      <div class="hidden md:flex md:flex-1 md:items-center md:justify-between">
        ...
        <div class="flex items-center md:ml-12">
          <a href="<?php echo site_url('login'); ?>" class="text-base font-medium text-gray-500 hover:text-gray-900">Sign in</a>
          <a href="<?php echo site_url('register'); ?>" class="ml-8 inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Sign up</a>
        </div>
      </div>
    </div>
  </div>
